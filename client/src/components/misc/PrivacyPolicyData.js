...
export const text = [
    ...
    body: (
      <>
        <p>
          ...
          globalhunch.io, from your website, from media and publications, from
  ...
  {
    header: "Access to your Personal Information",
    body: (
      <>
        <p>
        ...
        <p>
          <span>Global Hunch</span> will not charge any fee for your access
  ...
  {
    header: "Privacy Policy Complaints and Enquiries",
    body: (
      <>
        <p>
        ...
        <p>Sydney, New South Wales 2000 Australia</p>
        <p>info@globalhunch.com</p>
      </>
    )
  }
];
